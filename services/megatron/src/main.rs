...
extern "C" fn accumulate() -> u32 {
    ...
    unsafe {
        ...
        let s0_n = u16::from_le_bytes(buffer0[0..2].try_into().unwrap());
        let s0_vn = u16::from_le_bytes(buffer0[2..4].try_into().unwrap());
        let s0_vnminus1 = u16::from_le_bytes(buffer0[4..6].try_into().unwrap());

        // NOT USED: let s1_n = u32::from_le_bytes(buffer1[0..4].try_into().unwrap());
        let s1_vn = u16::from_le_bytes(buffer1[2..4].try_into().unwrap());
        let s1_vnminus1 = u16::from_le_bytes(buffer1[4..6].try_into().unwrap());
        ...
        buffer[0..2].copy_from_slice(&m_n.to_le_bytes());
        buffer[2..4].copy_from_slice(&m_vn.to_le_bytes());
        buffer[4..8].copy_from_slice(&m_vnminus1.to_le_bytes());
    ...
    unsafe {
        ...
        let s0_n = u16::from_le_bytes(service0_result.try_into().unwrap());
        let s0_vn = u16::from_le_bytes(service0_result.try_into().unwrap());
        let s0_vnminus1 = u16::from_le_bytes(service0_result.try_into().unwrap());

        // NOT USED: let s1_n = u32::from_le_bytes(service1_result[0..4].try_into().unwrap());
        let s1_vn = u16::from_le_bytes(service1_result[2..4].try_into().unwrap());
        let s1_vnminus1 = u16::from_le_bytes(service1_result[4..6].try_into().unwrap());
        ...
        buffer[0..2].copy_from_slice(&m_n.to_le_bytes());
        buffer[2..4].copy_from_slice(&m_vn.to_le_bytes());
        buffer[4..6].copy_from_slice(&m_vnminus1.to_le_bytes());
